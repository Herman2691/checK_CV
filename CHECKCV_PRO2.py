...
import os
from mistralai import Mistral  # ✅ CORRIGÉ : nouveau SDK Mistral
import json
...
# ✅ CORRIGÉ : Utilisation du nouveau SDK Mistral
@st.cache_resource
def init_mistral():
    ...
    if not api_key:
        ...
        st.stop()
    return Mistral(api_key=api_key)  # ✅ CORRIGÉ : Mistral() au lieu de MistralClient()
...
{{
  ...
  "recommandations": ["rec1", "rec2", "rec3"]
    ...
    try:
        # ✅ CORRIGÉ : client.chat.complete() avec le nouveau SDK Mistral
